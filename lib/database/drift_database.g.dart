...
class $ScheduleTableTable extends ScheduleTable
  ...
  late final GeneratedColumn<int> endTime = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _selectedCategoryMeta =
      const VerificationMeta('selectedCategory');
  @override
  late final GeneratedColumn<int> selectedCategory = GeneratedColumn<int>(
      'selected_category', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  ...
  VerificationContext validateIntegrity(Insertable<ScheduleTableData> instance,
    ...
    if (data.containsKey('selected_category')) {
      context.handle(
          _selectedCategoryMeta,
          selectedCategory.isAcceptableOrUnknown(
              data['selected_category']!, _selectedCategoryMeta));
    } else if (isInserting) {
      context.missing(_selectedCategoryMeta);
    }
  ...
  ScheduleTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ScheduleTableData(
      ...
      selectedCategory: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}selected_category'])!,
...
class ScheduleTableData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['selected_category'] = Variable<int>(selectedCategory);
  ...
  factory ScheduleTableData.fromJson(Map<String, dynamic> json,
    ...
    return ScheduleTableData(
      ...
      selectedCategory: serializer.fromJson<int>(json['selectedCategory']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'selectedCategory': serializer.toJson<int>(selectedCategory),
  ...
  String toString() {
    return (StringBuffer('ScheduleTableData(')
          ...
          ..write('selectedCategory: $selectedCategory, ')
  ...
  @override
  int get hashCode => Object.hash(id, startTime, endTime, selectedCategory,
      content, date, color, createdAt);
  @override
  bool operator ==(Object other) =>
      ...
      (other is ScheduleTableData &&
          ...
          other.selectedCategory == this.selectedCategory &&
...
class ScheduleTableCompanion extends UpdateCompanion<ScheduleTableData> {
  ...
  final Value<int> selectedCategory;
  ...
  const ScheduleTableCompanion({
    ...
    this.selectedCategory = const Value.absent(),
  ...
  static Insertable<ScheduleTableData> custom({
    ...
    Expression<int>? selectedCategory,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (selectedCategory.present) {
      map['selected_category'] = Variable<int>(selectedCategory.value);
    }
    if (content.present) {
  ...
  $$ScheduleTableTableTableManager(_$AppDatabase db, $ScheduleTableTable table)
      : super(TableManagerState(
          ...
          getUpdateCompanionBuilder: ({
            ...
            Value<int> selectedCategory = const Value.absent(),
...
class $$ScheduleTableTableFilterComposer
  ...
  ColumnFilters<int> get selectedCategory => $state.composableBuilder(
      column: $state.table.selectedCategory,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$ScheduleTableTableOrderingComposer
  ...
  ColumnOrderings<int> get selectedCategory => $state.composableBuilder(
      column: $state.table.selectedCategory,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
